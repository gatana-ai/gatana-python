...
class ServerRunningStatusResponse:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        pods = []
        for componentsschemas_schema250_item_data in self.pods:
            componentsschemas_schema250_item = componentsschemas_schema250_item_data.to_dict()
            pods.append(componentsschemas_schema250_item)
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        pods = []
        _pods = d.pop("pods")
        for componentsschemas_schema250_item_data in _pods:
            componentsschemas_schema250_item = ServerPodStatus.from_dict(componentsschemas_schema250_item_data)
