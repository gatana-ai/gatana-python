...
T = TypeVar("T", bound="Schema61Type0AsType0")


@_attrs_define
class Schema61Type0AsType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        schema_61_type_0_as_type_0 = cls(
            issuer=issuer,
        ...
        schema_61_type_0_as_type_0.additional_properties = d
        return schema_61_type_0_as_type_0
