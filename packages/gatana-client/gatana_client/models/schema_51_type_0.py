...
from ..models.schema_51_type_0_grant_type import Schema51Type0GrantType
from ..types import UNSET, Unset

T = TypeVar("T", bound="Schema51Type0")
...
class Schema51Type0:
    ...
    Attributes:
        ...
        grant_type (Schema51Type0GrantType | Unset):
    ...
    grant_type: Schema51Type0GrantType | Unset = UNSET
    client_auth_method: (
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_grant_type, Unset):
            ...
            grant_type = Schema51Type0GrantType(_grant_type)
        ...
        def _parse_client_auth_method(
            ...
            if client_auth_method_type_0 != "client_secret_basic":
                raise ValueError(
                    f"clientAuthMethod_type_0 must match const 'client_secret_basic', got '{client_auth_method_type_0}'"
                )
            ...
            if client_auth_method_type_1 != "client_secret_post":
                raise ValueError(
                    f"clientAuthMethod_type_1 must match const 'client_secret_post', got '{client_auth_method_type_1}'"
                )
        ...
        schema_51_type_0.additional_properties = d
        return schema_51_type_0
