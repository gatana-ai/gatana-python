...
T = TypeVar("T", bound="GetMcpServersServerSlugCredentialsProfileProfileIdApikeysResponse200")



@_attrs_define
class GetMcpServersServerSlugCredentialsProfileProfileIdApikeysResponse200:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_mcp_servers_server_slug_credentials_profile_profile_id_apikeys_response_200 = cls(
            apikeys=apikeys,
        )

        return get_mcp_servers_server_slug_credentials_profile_profile_id_apikeys_response_200
