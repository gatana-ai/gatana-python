...
from ..models.schema_61_type_0_grant_type import Schema61Type0GrantType
from ..types import UNSET, Unset

T = TypeVar("T", bound="Schema61Type0")
...
class Schema61Type0:
    ...
    Attributes:
        ...
        grant_type (Schema61Type0GrantType | Unset):
    ...
    grant_type: Schema61Type0GrantType | Unset = UNSET
    client_auth_method: (
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_grant_type, Unset):
            ...
            grant_type = Schema61Type0GrantType(_grant_type)
        ...
        schema_61_type_0.additional_properties = d
        return schema_61_type_0
