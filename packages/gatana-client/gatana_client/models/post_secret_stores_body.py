        ...
        def _parse_configuration(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                componentsschemas_schema90_type_0 = AwsSecretsManagerConfiguration.from_dict(data)

                return componentsschemas_schema90_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                componentsschemas_schema90_type_1 = GcpSecretManagerConfiguration.from_dict(data)

                return componentsschemas_schema90_type_1
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                componentsschemas_schema90_type_2 = HashiCorpVaultConfiguration.from_dict(data)

                return componentsschemas_schema90_type_2
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                componentsschemas_schema90_type_3 = InfisicalConfiguration.from_dict(data)

                return componentsschemas_schema90_type_3
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            if not isinstance(data, dict):
                raise TypeError()
            componentsschemas_schema90_type_4 = AzureKeyVaultConfiguration.from_dict(data)

            return componentsschemas_schema90_type_4
