...
if TYPE_CHECKING:
    from ..models.schema_129_abilities import Schema129Abilities
    from ..models.schema_131 import Schema131


T = TypeVar("T", bound="Schema129")
...
class Schema129:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_member_default_role(data: object) -> Literal["none"] | Schema130:
            try:
                if not isinstance(data, str):
                    raise TypeError()
                member_default_role_type_0 = Schema130(data)
        ...
        abilities = Schema129Abilities.from_dict(d.pop("abilities"))
