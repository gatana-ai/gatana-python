...
T = TypeVar("T", bound="GetMcpServersServerSlugCredentialsUserApikeysResponse200")



@_attrs_define
class GetMcpServersServerSlugCredentialsUserApikeysResponse200:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_mcp_servers_server_slug_credentials_user_apikeys_response_200 = cls(
            apikeys=apikeys,
        )

        return get_mcp_servers_server_slug_credentials_user_apikeys_response_200
