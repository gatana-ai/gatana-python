...
T = TypeVar("T", bound="GetMcpServersServerSlugCredentialsServerResponse200")



@_attrs_define
class GetMcpServersServerSlugCredentialsServerResponse200:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_mcp_servers_server_slug_credentials_server_response_200 = cls(
            credentials=credentials,
        )

        return get_mcp_servers_server_slug_credentials_server_response_200
