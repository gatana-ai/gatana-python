...
T = TypeVar("T", bound="Schema60Type0AsType0")


@_attrs_define
class Schema60Type0AsType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        schema_60_type_0_as_type_0 = cls(
            issuer=issuer,
        ...
        schema_60_type_0_as_type_0.additional_properties = d
        return schema_60_type_0_as_type_0
