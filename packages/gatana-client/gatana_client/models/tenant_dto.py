...
from ..models.schema_339 import Schema339
from ..models.schema_342 import Schema342
from ..models.schema_343 import Schema343

if TYPE_CHECKING:
    from ..models.schema_131 import Schema131
...
class TenantDto:
    ...
    Attributes:
        ...
        output_compression_ai_model (Schema339):
        member_default_role (Literal['none'] | Schema130):
        mcp_audit_log_level (McpAuditLogVerbosity):
        default_resource_limits (Schema131):
        deployment_resource_limits (Schema131):
        is_scim_enabled (bool):
        scim_group_delete_behavior (Schema342):
        scim_user_delete_behavior (Schema343):
    """
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.member_default_role, Schema130):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_upstream_oidc_configuration(data: object) -> None | TenantOidcConfiguration:
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                componentsschemas_schema303_type_0 = TenantOidcConfiguration.from_dict(data)

                return componentsschemas_schema303_type_0
        ...
        def _parse_upstream_saml_configuration(data: object) -> None | TenantSamlConfiguration:
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                componentsschemas_schema317_type_0 = TenantSamlConfiguration.from_dict(data)
        ...
        output_compression_ai_model = Schema339(d.pop("outputCompressionAiModel"))

        def _parse_member_default_role(data: object) -> Literal["none"] | Schema130:
            try:
                if not isinstance(data, str):
                    raise TypeError()
                componentsschemas_schema340_type_0 = Schema130(data)

                return componentsschemas_schema340_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            componentsschemas_schema340_type_1 = cast(Literal["none"], data)
            if componentsschemas_schema340_type_1 != "none":
                raise ValueError(
                    f"/components/schemas/__schema340_type_1 must match const 'none', got '{componentsschemas_schema340_type_1}'"
                )
            return componentsschemas_schema340_type_1
        ...
        default_resource_limits = Schema131.from_dict(d.pop("defaultResourceLimits"))

        deployment_resource_limits = Schema131.from_dict(d.pop("deploymentResourceLimits"))

        is_scim_enabled = d.pop("isScimEnabled")

        scim_group_delete_behavior = Schema342(d.pop("scimGroupDeleteBehavior"))

        scim_user_delete_behavior = Schema343(d.pop("scimUserDeleteBehavior"))
