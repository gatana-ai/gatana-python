...
T = TypeVar("T", bound="Schema61Type0ResourceType0")


@_attrs_define
class Schema61Type0ResourceType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        schema_61_type_0_resource_type_0 = cls(
            id=id,
            available_scopes=available_scopes,
            metadata_url=metadata_url,
        )

        schema_61_type_0_resource_type_0.additional_properties = d
        return schema_61_type_0_resource_type_0
