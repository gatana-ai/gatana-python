...
class DeploymentStatusResponse:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        deployments = []
        for componentsschemas_schema351_item_data in self.deployments:
            componentsschemas_schema351_item = componentsschemas_schema351_item_data.to_dict()
            deployments.append(componentsschemas_schema351_item)
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for componentsschemas_schema351_item_data in _deployments:
            componentsschemas_schema351_item = DeploymentStatus.from_dict(componentsschemas_schema351_item_data)
