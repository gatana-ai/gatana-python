...
T = TypeVar("T", bound="Schema50Type0AsType0")


@_attrs_define
class Schema50Type0AsType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        no_dynamic_client_registration_reason = _parse_no_dynamic_client_registration_reason(
            d.pop("noDynamicClientRegistrationReason", UNSET)
        )
        ...
        schema_50_type_0_as_type_0 = cls(
            issuer=issuer,
        ...
        schema_50_type_0_as_type_0.additional_properties = d
        return schema_50_type_0_as_type_0
