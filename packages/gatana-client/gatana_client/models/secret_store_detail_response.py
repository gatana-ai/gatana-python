...
from ..models.schema_435 import Schema435
        ...
        def _parse_configuration(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                componentsschemas_schema439_type_0 = AwsSecretsManagerConfigurationOutput.from_dict(data)

                return componentsschemas_schema439_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                componentsschemas_schema439_type_1 = GcpSecretManagerConfigurationOutput.from_dict(data)

                return componentsschemas_schema439_type_1
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                componentsschemas_schema439_type_2 = HashiCorpVaultConfigurationOutput.from_dict(data)

                return componentsschemas_schema439_type_2
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                componentsschemas_schema439_type_3 = InfisicalConfigurationOutput.from_dict(data)

                return componentsschemas_schema439_type_3
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            if not isinstance(data, dict):
                raise TypeError()
            componentsschemas_schema439_type_4 = AzureKeyVaultConfigurationOutput.from_dict(data)

            return componentsschemas_schema439_type_4
