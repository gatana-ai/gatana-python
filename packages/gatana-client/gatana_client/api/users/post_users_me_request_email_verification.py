...
from ...models.post_users_me_request_email_verification_response_200 import (
...
) -> PostUsersMeRequestEmailVerificationResponse200 | None:
    if response.status_code == 200:
        response_200 = PostUsersMeRequestEmailVerificationResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[PostUsersMeRequestEmailVerificationResponse200]:
    return Response(
